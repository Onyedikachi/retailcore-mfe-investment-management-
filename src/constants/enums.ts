...
export enum Messages {
  ...
  PRODUCT_BULK_CREATE_APPROVED = "Product bulk creation approved",
  PRODUCT_BULK_CREATE_REJECTED = "Product bulk creation rejected",
...
export enum Prompts {
  ...
  PRODUCT_BULK_CREATION_REJECT = "Do you want to reject bulk product creation?",
  PRODUCT_BULK_CREATION_APPROVE = "Do you want to approve bulk product creation?",
