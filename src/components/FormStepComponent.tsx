  ...
  return (
    <div className="flex bg-white justify-center ">
      ...
      {formStepItems.map((item) => (
        <div key={item.id} data-testid="form-step" className="flex flex-col items-center w-[200px]">
          {item.index == step ||
          ...
          <div className="w-full mb-[13px] flex  items-center">
            <div
              className={`${item.index === formStepItems[0].index ? "" : "bg-[#AAAAAA]"
                } h-[1px] w-full`}
            ></div>
            ...
            <div
              className={`${item.index === formStepItems[formStepItems.length - 1].index
                  ? ""
                  : "bg-[#AAAAAA]"
                } h-[1px] w-full `}
            ></div>
          ...
          <div className="w-full px-4 text-center">
            <span data-testid="form-step-item-label" className="uppercase text-center text-[#636363] leading-normal text-xs font-normal block">
              {item.label}
            </span>
          </div>
        </div>
