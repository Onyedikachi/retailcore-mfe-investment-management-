...
import IndexComponent from "../../../../../../pages/management/book-investment/certificate/IndexComponent";
...
jest.mock("../../../../../../api", () => ({
    ...
    useGetInvestmentCertificateQuery: jest.fn().mockReturnValue({ data: "" }),
    useGetApplicableChargesQuery: jest.fn().mockReturnValue({ data: "" }),
    useGetApplicableTaxesQuery: jest.fn().mockReturnValue({ data: "" }),
    useGetWideChargesQuery: jest.fn().mockReturnValue({ data: "" }),
}));
...
describe("IndexComponent", () => {
    it("should render", () => {
        renderWithProviders(<IndexComponent productDetail={productDetail} />);
    })
})