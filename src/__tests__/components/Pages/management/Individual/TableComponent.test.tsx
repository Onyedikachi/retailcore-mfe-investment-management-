...
import TableComponent, {
  ...
  initiateDownload,
} from "../../../../../components/pages/management/individual/TableComponent";
...
describe('handleProductIsSuccess', () => {

  // If productDownloadIsSuccess is true and category is Investments, handleDownload function is called with transformed productDownloadData results
  it('should call handleDownload with transformed productDownloadData results when productDownloadIsSuccess is true and category is Investments', () => {
  ...
  // If requestsDownloadIsSuccess is true and category is Requests, handleDownload function is called with transformed requestsDownloadData results
  it('should call handleDownload with transformed requestsDownloadData results when requestsDownloadIsSuccess is true and category is Requests', () => {
    const productDownloadIsSuccess = false;
    const category = StatusCategoryType.Requests;
    const isChecker = false;
    const csvExporter = new ExportToCsv();
    const productDownloadData = null;
  ...
  // If productDownloadIsSuccess is false and category is Investments, handleDownload function is not called
  it('should not call handleDownload when productDownloadIsSuccess is false and category is Investments', () => {
    const productDownloadIsSuccess = false;
    const category = StatusCategoryType.Investments;
    const isChecker = false;
    const csvExporter = new ExportToCsv();
  ...
  // If requestsDownloadIsSuccess is false and category is Requests, handleDownload function is not called
  it('should not call handleDownload when requestsDownloadIsSuccess is false and category is Requests', () => {
    const productDownloadIsSuccess = false;
    const category = StatusCategoryType.Requests;
    const isChecker = false;
    const csvExporter = new ExportToCsv();
  ...
  // If category is not Investments or Requests, handleDownload function is not called
  it('should not call handleDownload when category is not Investments or Requests', () => {
    const productDownloadIsSuccess = true;
  ...
  // If productDownloadData or requestsDownloadData is null or undefined, handleDownload function is not called
  it('should call handleDownload when productDownloadData or requestsDownloadData is null or undefined', () => {
    const productDownloadIsSuccess = true;
    const category = StatusCategoryType.Investments;
    const isChecker = false;
    const csvExporter = new ExportToCsv();
    const productDownloadData = null;
    const requestsDownloadIsSuccess = true;
    const requestsDownloadData = undefined;
    const handleDownload = jest.fn();
