...
describe('handleIndividualListHeaders', () => {

  // Given a non-empty array of results, the function should map the results to an array of objects with id, name, and value properties, and update the options of the 'investmentProduct' item in the individualHeader array with the mapped results.
  it('should update options of "investmentProduct" item when given non-empty array of results', () => {
    // Arrange
    const results = [
      { id: 1, productName: "Product 1" },
      { id: 2, productName: "Product 2" },
    ];
    const setIndividualListHeaders = jest.fn();

    // Act
    handleIndividualListHeaders({ results, setIndividualListHeaders });

    // Assert
    expect(setIndividualListHeaders).toHaveBeenCalledWith([
      {
  ...
  // Given an empty array of results, the function should not update the options of the 'investmentProduct' item in the individualHeader array.
  it('should not update options of "investmentProduct" item when given empty array of results', () => {
    // Arrange
    const results = [];
    const setIndividualListHeaders = jest.fn();
    ...
    // Assert
    expect(setIndividualListHeaders).toHaveBeenCalled();
  });

  // Given a null or undefined results parameter, the function should not update the options of the 'investmentProduct' item in the individualHeader array.
  it('should not update options of "investmentProduct" item when given null or undefined results parameter', () => {
    // Arrange
    const results = null;
    const setIndividualListHeaders = jest.fn();
    ...
    // Assert
    expect(setIndividualListHeaders).not.toHaveBeenCalled();
  })
});
